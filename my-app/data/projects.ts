...
export const projects: Project[] = [
  ...
  },
  {
    ...
    techStack: ["AWS EKS", "NVIDIA NIM", "FastAPI", "OpenSearch", "Docker", "Kubernetes"],
    metrics: metrics([
  ...
  },
  {
    ...
    techStack: ["Python", "AWS Bedrock", "FastAPI", "Streamlit", "DynamoDB"],
    metrics: metrics([
